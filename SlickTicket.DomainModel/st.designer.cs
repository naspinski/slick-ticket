...
namespace SlickTicket.DomainModel
{
    ...
    partial void OnactiveChanged();
		...
		[Column(Storage="_attachment_name", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_attachment_size", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
    ...
    partial void OnactiveChanged();
		...
		[Column(Name="comment", Storage="_comment1", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
    ...
    partial void OnoccuredChanged();
		...
		[Column(Storage="_occured", DbType="DateTime NOT NULL")]
    ...
    partial void OnlevelChanged();
		...
		[Column(Storage="_priority_name", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
    ...
    partial void Onsecurity_level_descriptionChanged();
		...
		[Column(Storage="_security_level_name", DbType="NVarChar(50)")]
		...
		[Column(Storage="_security_level_description", DbType="NVarChar(MAX)")]
    ...
    partial void Onstatus_nameChanged();
		...
		[Column(Storage="_status_name", DbType="NVarChar(50)")]
    ...
    partial void OnbackgroundChanged();
		...
		[Column(Storage="_style_name", DbType="NVarChar(50) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_text_color", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_borders", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_body", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		public string body
		{
			get
			{
		...
		[Column(Storage="_links", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		public string links
		{
			get
			{
		...
		[Column(Storage="_hover", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		public string hover
		{
			get
			{
		...
		[Column(Storage="_button_text", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_header", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_alt_rows", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_background", DbType="NVarChar(10) NOT NULL", CanBeNull=false)]
    ...
    partial void OnmailtoChanged();
		...
		[Column(Storage="_sub_unit_name", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_mailto", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
    ...
    partial void Onunit_nameChanged();
		...
		[Column(Storage="_unit_name", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
    ...
    partial void Onsecurity_levelChanged();
		...
		[Column(Storage="_ad_group", DbType="NVarChar(100) NOT NULL", CanBeNull=false)]
